...
10. **Review loop** - When the user asks to repeat review until clean, invoke `review-loop`. Exit after one fresh review of the current digest has zero unresolved blocking findings.
