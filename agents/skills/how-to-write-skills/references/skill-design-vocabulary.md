...
Vendored from [mattpocock/skills `writing-great-skills`](https://github.com/mattpocock/skills/tree/main/skills/productivity/writing-great-skills) (MIT). Principles summary: [skill-design-principles.md](skill-design-principles.md). Operational authoring guide: `how-to-write-skills/SKILL.md`.
