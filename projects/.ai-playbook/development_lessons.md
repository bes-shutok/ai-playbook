...
## 125. Active Code Review Must Gate Authorization Findings on PR Story Scope and Author-Documented MVP Intent, Not Domain Seed Data Alone
...
4. Distinguish "the gate fired and was overridden" (#165), "the skill was loaded but its gates skipped" (#178), and "the producer never had a gate" (this lesson). The first two are execution failures against an existing mechanism; the third is a missing mechanism and requires adding the gate, not lecturing the agent.
