...
**See also:** coding_guidelines.md #25 (Family H parent), #87 (committed-files false-green; the mechanical inverse), `agent_workflow_guidelines.md` §39 (em-dash policy) and §891 (two-part instruction anti-pattern), `doing-code-review/SKILL.md` (style-preference findings must cite a canonical doc, not personal docs), CLAUDE.md §4 Agent Workflow Rules.
