...
Status: open
Priority: high (revived 2026-09-12 per user decision: code quality added as the fourth driving principle (guidelines section 64) - review-coverage and validator-correctness value is no longer priced at zero; this one is a validator correctness bug, not hardening)
