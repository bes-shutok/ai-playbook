...
Done note (2026-09-14): all nine findings landed via `docs/plans/completed/2026-09-13-execute-plan-runtime-r5-residuals-yagni-trim.md` (Tasks 1-8); the out-of-lens observation above was deliberately not fixed there and stays a recorded question for a future pass.
